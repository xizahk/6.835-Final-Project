...
//		}
	...
	protected Vector3 Kinect2AvatarPos(Vector3 jointPosition, bool bMoveVertically)
	{
		...
		// TODO: Delete later
		string xstring = avatarJointPos.x.ToString();
		string ystring = avatarJointPos.y.ToString();
		string zstring = avatarJointPos.z.ToString();
		//Debug.Log("avatar vec: " + xstring + ", " + ystring + ", " + zstring);
